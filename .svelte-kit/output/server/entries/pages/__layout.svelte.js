import { c as create_ssr_component, v as validate_component, a as add_attribute, b as add_styles, e as escape, d as subscribe, f as add_classes } from "../../chunks/index-e8e3b014.js";
import { I as Icon } from "../../chunks/icon-23cea8eb.js";
import { s as session } from "../../chunks/stores-b8f73eaf.js";
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer class="${"bg-white mt-20 dark:bg-gray-800 pb-8 xl:pt-8"}"><div class="${"max-w-screen-lg xl:max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 text-gray-400 dark:text-gray-300"}"><ul class="${"text-lg font-light pb-8 flex flex-wrap justify-center"}"><li class="${"w-1/2 md:w-1/3 lg:w-1/3"}"><div class="${"text-center"}"><h2 class="${"text-gray-500 dark:text-gray-200 text-md uppercase mb-4"}">Components</h2>
			...
			<li class="${"w-1/2 md:w-1/3 lg:w-1/3"}"><div class="${"text-center"}"><h2 class="${"text-gray-500 dark:text-gray-200 text-md uppercase mb-4"}">Contacts</h2>
			...
			<li class="${"w-1/2 md:w-1/3 lg:w-1/3"}"><div class="${"text-center"}"><h2 class="${"text-gray-500 dark:text-gray-200 text-md uppercase mb-4"}">Company</h2>
					<ul><li class="${"mb-4 hover:text-gray-800 dark:hover:text-white transition-colors duration-200"}"><a href="${"/privacy"}">Privacy </a></li>
						<li class="${"mb-4 hover:text-gray-800 dark:hover:text-white transition-colors duration-200"}"><a href="${"/about"}">About Us </a></li>
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  }, `py-2 px-4 flex justify-center items-center text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none rounded-[5px]`, "flex items-center align-center", klass);
  if ($$props.iconOutline === void 0 && $$bindings.iconOutline && iconOutline !== void 0)
    $$bindings.iconOutline(iconOutline);
  ...
  if ($$props.role === void 0 && $$bindings.role && role !== void 0)
    $$bindings.role(role);
  iconKlasses = c("text-center mr-1", { "animate-spin": loading }, iconOutline ? "material-icons-outlined" : "material-icons");
  return `<button ${disabled || loading ? "disabled" : ""} type="${"button"}"${add_attribute("class", textButton, 0)}>${icon ? `<span${add_attribute("class", iconKlasses, 0)}${add_styles({ "font-size": `20px` })}>${escape(icon)}</span>` : ``}
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_session();
  return `<nav class="${"w-full p-2 shadow-xs bg-[rgb(79,70,229)] mb-8"}"><div class="${"container mx-auto flex flex-row items-center justify-between"}"><a href="${"/"}"><div class="${"text-xl text-white mr-14 font-bold flex"}">BidKaro</div></a>
    ${validate_component(Search, "Search").$$render($$result, {}, {}, {})}
    <div class="${"flex ml-auto self-end md:flex gap-4"}">${$session && $session.userId ? `<a href="${"/dashboard/items/new"}">${validate_component(Button, "Button").$$render($$result, {}, {}, {
    default: () => {
      return `New`;
    }
  })}</a>
        <a href="${"/dashboard/items"}">${validate_component(Button, "Button").$$render($$result, {}, {}, {
    default: () => {
      return `Dashboard`;
    }
  })}</a>` : `<a href="${"/auth/signin"}">${validate_component(Button, "Button").$$render($$result, {}, {}, {
    default: () => {
      return `Sign In`;
    }
  })}</a>
        <a href="${"/auth/signup"}">${validate_component(Button, "Button").$$render($$result, {}, {}, {
    default: () => {
      return `Sign Up`;
    }
  })}</a>`}</div>
	${$session && $session.userId ? `<div class="${"relative ml-3"}"><div><button type="${"button"}" class="${"relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"}" id="${"user-menu-button"}"${add_attribute("aria-expanded", showDropdown, 0)} aria-haspopup="${"true"}"><span class="${"absolute -inset-1.5"}"></span>
