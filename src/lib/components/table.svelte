...
<table class="table table-auto p-4 w-full bg-white shadow rounded-lg ">
  <thead class="bg-[rgb(79,70,229)] text-white">
    <tr>
      {#each columns as column}
        <th
          ...
          on:click={() =>
            column.sortable && onHeaderClick(column.id || column.field)}
        >
          {column.label}
