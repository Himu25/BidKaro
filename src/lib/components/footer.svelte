...
<footer class="bg-white mt-20 dark:bg-gray-800 pb-8 xl:pt-8">
  ...
  >
    ...
    <div
      class="pt-8 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-between"
    >
      <a href="/">
        <Icon name="language" />
      </a>
    ...
    <div
      class="text-center pt-10 sm:pt-12 font-light flex items-center justify-center"
    >
      <form
      ...
      >
        ...
        <button
          class="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-[rgb(79,70,229)] rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200"
          type="submit"
        >
          Subscribe
        </button>
