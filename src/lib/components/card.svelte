...
<div class="w-80 flex justify-center items-center">
  <div class="w-full p-2">
    <div
      class="card flex flex-col justify-center p-8  bg-white shadow border rounded-lg"
    >
      <div class="prod-title">
        <a href={`/items/${item.id}`}>
          <p
            class="h-16 text-ellipsis overflow-hidden text-xl uppercase text-gray-900 font-bold"
          >
            {item.name}
          </p>
        </a>
